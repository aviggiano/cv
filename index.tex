...
\cventry{Nov 2014 -- Aug 2017}{Co-founder \& Tech Lead}{BelugaDB}{}{Brazil}{
  ...
  insights through dashboards and machine learning recommendations
  \\ - Lead a group of 4 senior programmers as the lead database developer.
  \\ - Responsible for developing a high-performance distributed columnar database capable of handling terabytes of data in milliseconds, outperforming the industry's open-source standard in some benchmarks
  ...
  \\ - In charge of the hiring process, as well as of the onboarding and
  mentoring of new employees
  \ENTRYSPACE
}

\cventry{Mar 2014 -- Out 2014}{Software Engineer Intern}{Revmob Mobile Ad Network}{}{Brazil}{
  - Revmob is the leading mobile ad networks when it comes to monetization of iOS, Android and Amazon.
  \\ - Lead a task force of 3 people which reduced web fraud by 80\% by analyzing suspicious traffic from different data sources and request patterns
  \\ - Lead the integration team of 5 people which increased the revenue of publishers by 15\% by partnering with demand-side platforms and adapting the company's software development kit to comply with newer industry standards
  \\ - Helped design and lead the onboarding process of the company by structuring programming crash courses, culture meetings and other activities with new hires
  \\ - Helped restructure the company's security policies by adopting AWS security guidelines
  \ENTRYSPACE
}
