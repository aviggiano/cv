...
\cventry{2011~\textemdash~2013}{General Engineering (Master's degree)}{École Centrale Marseille}{Double Degree}{}{
  ...
  \\ \Cdot Participated in many computer science and mathematics projects throughout the course, including the development of a traveling expert system; elaboration of an online search engine and classifier of Project Gutenberg's e-books; resolution of various Project Euler problems in the university's Programming Club  
  \ENTRYSPACE
}
...
\cventry{2009~\textemdash~2014}{Mechatronics Engineering (Bachelor's
  ...
  \\ \Cdot Thesis: Development of a recommender system for the suggestion of products in e-commerce 
  ...
  \\ \Cdot Research Intern in the Bioengineering Laboratory for 8 months, having developed a filter that separates ventilation and perfusion images in electrical impedance tomography using the Hilbert-Huang Transform
...
\cventry{Nov 2014 \newline{\textemdash} \newline{Aug 2017} \newline{}}{Co-founder \& Tech Lead}{BelugaDB}{}{Brazil}{
  ...
  \\ \Cdot Participated in the main areas of the organization, including the data storage, data extraction and data visualization divisions, as well as in key areas such as hiring, onboarding, mentoring and strategic planning\ENTRYSPACE
}
...
\cvline{Programming}{Proficient in C/C\texttt{++}, Node.js, Bash, AWS and related technologies;
  open source contributor and author of a compressed bitmap library, one of the top 10 most starred Redis modules; developed a crowdsourcing app in the São Paulo Public Transportation Hackathon and got the second place among over 50 teams \ENTRYSPACE}
...
\cvline{Hobbies}{Guitar playing (member of a rock band, having played in many
  ...
  table tennis (participated in a state competition) \ENTRYSPACE
}

\cvline{Charity Work}{Member of TECHO (nonprofit organization that fights extreme poverty in Latin America with housing and inclusion programs); mathematics, physics and chemistry assistant teacher in high school}
