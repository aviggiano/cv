...
\cvline{Programming}{Proficient in C/\CC, Node.js, Bash, AWS and related technologies;
  open source contributor and author of a compressed bitmaps library, one of the top 10 most starred Redis modules; developed a crowdsourcing app in the São Paulo Public Transportation Hackathon and achieved the second place among over 50 teams}
