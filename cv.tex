...
\cventry{2009~\textemdash~2014}{Mechatronics Engineering (Bachelor's
  ...
  \\ \Cdot Undergraduate Researcher in the Bioengineering Laboratory for 8 months, having developed a filter that separates ventilation and perfusion images in electrical impedance tomography using the Hilbert-Huang Transform (Research Advisor: Prof. Raul Lima)
...
\cvline{Programming}{Proficient in C/\CC, Node.js, Bash, AWS and related technologies;
  open source contributor and author of a compressed bitmaps library, one of the top 10 most starred Redis modules; developed a crowdsourcing app in the São Paulo Public Transportation Hackathon and got the second place among over 50 teams}
